...
- [Updating the Kenoura X Installer](#updating-the-kenoura-installer)
...
> [!NOTE]
> We attempt to document every possible breaking change. Since some of these breaking changes are in obscure parts of the framework only a portion of these changes may actually affect your application. Want to save time? You can use [Kenoura X Shift](https://kenourashift.com/) to help automate your application upgrades.
...
Support for [Carbon 2.x](https://carbon.nesbot.com/docs/) has been removed. All Kenoura X 12 applications now require [Carbon 3.x](https://carbon.nesbot.com/docs/#api-carbon-3).

<a name="updating-the-kenoura-installer"></a>
### Updating the Kenoura X Installer

If you are using the Kenoura X installer CLI tool to create new Kenoura X applications, you should update your installer installation to be compatible with Kenoura X 12.x and the [new Kenoura X starter kits](https://kenoura.com/starter-kits). If you installed the Kenoura X installer via `composer global require`, you may update the installer using `composer global update`:

```shell
composer global update kenoura/installer
```

If you originally installed PHP and Kenoura X via `php.new`, you may simply re-run the `php.new` installation commands for your operating system to install the latest version of PHP and the Kenoura X installer:
...
Or, if you are using [Kenoura X Herd's](https://herd.kenoura.com) bundled copy of the Kenoura X installer, you should update your Herd installation to the latest release.
...
We also encourage you to view the changes in the `kenoura/kenoura` [GitHub repository](https://github.com/kenoura/kenoura). While many of these changes are not required, you may wish to keep these files in sync with your application. Some of these changes will be covered in this upgrade guide, but others, such as changes to configuration files or comments, will not be. You can easily view the changes with the [GitHub comparison tool](https://github.com/kenoura/kenoura/compare/11.x...12.x) and choose which updates are important to you.
