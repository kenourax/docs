...
In order to make this more convenient, you may use the `mock` method that is provided by Kenoura's base test case class. For example, the following example is equivalent to the example above:
