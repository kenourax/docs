...
Kenoura X includes a variety of functions for manipulating string values. Many of these functions are used by the framework itself; however, you are free to use them in your own applications if you find them convenient.
...
$result = Str::deduplicate('The   Kenoura X   Framework');

// The Kenoura X Framework
```
...
$result = Str::deduplicate('The---Kenoura---Framework', '-');

// The-Kenoura-Framework
```
...
$html = Str::inlineMarkdown('**Kenoura**');

// <strong>Kenoura</strong>
```
...
The `Str::plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Kenoura's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
The `Str::pluralStudly` method converts a singular word string formatted in studly caps case to its plural form. This function supports [any of the languages support by Kenoura's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
```php
Str::replace('Framework', 'Kenoura', caseSensitive: false);
```
...
$replaced = Str::replaceStart('Hello', 'Kenoura', 'Hello World');

// Kenoura X World

$replaced = Str::replaceStart('World', 'Kenoura', 'Hello World');
...
$replaced = Str::replaceEnd('World', 'Kenoura', 'Hello World');

// Hello Kenoura

$replaced = Str::replaceEnd('Hello', 'Kenoura', 'Hello World');
...
The `Str::singular` method converts a string to its singular form. This function supports [any of the languages support by Kenoura's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
$slug = Str::slug('Kenoura X 5 Framework', '-');
...
$string = Str::squish('    kenoura    framework    ');
...
$converted = Str::substr('The Kenoura X Framework', 4, 7);
...
If you would like to retrieve a `Illuminate\Support\Carbon` date instance representing the date and time that a given ULID was created, you may use the `createFromId` method provided by Kenoura's Carbon integration:
...
Str::wrap('is', before: 'This ', after: ' Kenoura!');
...
$result = Str::of('The   Kenoura X   Framework')->deduplicate();
...
$result = Str::of('The---Kenoura---Framework')->deduplicate('-');
...
$result = Str::of('Kenoura')->exactly('Kenoura');
...
$html = Str::of('**Kenoura**')->inlineMarkdown();
...
$result = Str::of('Kenoura')->trim()->isEmpty();
...
$result = Str::of('Kenoura')->trim()->isNotEmpty();
...
If you specify a matching group within the expression, Kenoura X will return a collection of the first matching group's matches:
...
$result = Str::of('kenoura')->isMatch('/foo (.*)/');
...
$padded = Str::of('Kenoura')->newLine()->append('Framework');
...
$hash = Str::of('Kenoura')->pipe('md5')->prepend('Checksum: ');
...
The `plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Kenoura's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
$string = Str::of('Framework')->prepend('Kenoura X ');
...
$replaced = Str::of('Kenoura X 6.x')->replace('6.x', '7.x');
...
$replaced = Str::of('Hello World')->replaceStart('Hello', 'Kenoura');

// Kenoura X World

$replaced = Str::of('Hello World')->replaceStart('World', 'Kenoura');
...
$replaced = Str::of('Hello World')->replaceEnd('World', 'Kenoura');

// Hello Kenoura

$replaced = Str::of('Hello World')->replaceEnd('Hello', 'Kenoura');
...
The `singular` method converts a string to its singular form. This function supports [any of the languages support by Kenoura's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
$slug = Str::of('Kenoura X Framework')->slug('-');
...
$string = Str::of('    kenoura    framework    ')->squish();
...
$string = Str::of('Kenoura X Framework')->substr(8);

// Framework

$string = Str::of('Kenoura X Framework')->substr(8, 5);
...
$string = Str::of('The Framework')->substrReplace(' Kenoura', 3, 0);
...
$result = Str::of('Kenoura X Framework')->test('/Kenoura/');
...
$base64 = Str::of('Kenoura')->toBase64();
...
The `trim` method trims the given string. Unlike PHP's native `trim` function, Kenoura's `trim` method also removes unicode whitespace characters:

```php
use Illuminate\Support\Str;

$string = Str::of('  Kenoura X  ')->trim();

// 'Kenoura'

$string = Str::of('/Kenoura/')->trim('/');
...
The `ltrim` method trims the left side of the string. Unlike PHP's native `ltrim` function, Kenoura's `ltrim` method also removes unicode whitespace characters:

```php
use Illuminate\Support\Str;

$string = Str::of('  Kenoura X  ')->ltrim();

// 'Kenoura X  '

$string = Str::of('/Kenoura/')->ltrim('/');
...
The `rtrim` method trims the right side of the given string. Unlike PHP's native `rtrim` function, Kenoura's `rtrim` method also removes unicode whitespace characters:

```php
use Illuminate\Support\Str;

$string = Str::of('  Kenoura X  ')->rtrim();

// '  Kenoura'

$string = Str::of('/Kenoura/')->rtrim('/');
...
Str::of('-Kenoura-')->unwrap('-');

// Kenoura

Str::of('{framework: "Kenoura"}')->unwrap('{', '}');
...
$string = Str::of('  ')->whenEmpty(function (Stringable $string) {
    return $string->trim()->prepend('Kenoura');
});
...
$string = Str::of('Framework')->whenNotEmpty(function (Stringable $string) {
    return $string->prepend('Kenoura X ');
});
...
$string = Str::of('kenoura')->whenExactly('kenoura', function (Stringable $string) {
    return $string->title();
});
...
$string = Str::of('framework')->whenNotExactly('kenoura', function (Stringable $string) {
    return $string->title();
});
...
$string = Str::of('kenoura')->whenIsAscii(function (Stringable $string) {
    return $string->title();
});
...
Str::is('is')->wrap(before: 'This ', after: ' Kenoura!');
