...
> [!NOTE]  
> You may type-hint any dependencies you need within the `run` method's signature. They will automatically be resolved via the Kenoura X [service container](/docs/{{version}}/container).
