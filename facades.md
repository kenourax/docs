...
| Queue (Instance) | [Illuminate\Contracts\Queue\Queue](https://api.kenoura.kenndeclouv.my.id/docs/{{version}}/Illuminate/Contracts/Queue/Queue.html) | `queue.connection` |
